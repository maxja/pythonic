...
[Python][^3] - это [высокоуровневый, универсальный, динамически типизированный язык с сборкой мусора][^4]. Это многопарадигменный язык программирования, изначально разработанный Гвидо ван Россумом в 1991 году.
...
Полный [индекс][^5] предложений, которые уже приняты, и тех, которые только что были предложены.

### Zen of Python

Краткий и лаконичный способ описать принципы руководства Python, известные как Zen of Python, и да, у него есть свой собственный [PEP 20][^6], (перевод):
