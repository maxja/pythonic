...
|:---------|:--------------------|-------------:|--------------:|
|      <td colspan=4><em>Арифметические операции</em></td>      |
...
|  L // R  |            -        |  5 // 2 = 2  |  T // T = 1   |
|  L % R   |            -        |  5 // 2 = 1  |   T % T = 0   |
|        <td colspan=4><em>Побитовые операции</em></td>         |
|  L ^ R   |            -        |   5 ^ 2 = 7  |   F ^ T = T   |
|  L & R   |            -        |   5 & 2 = 0  |   F & T = F   |
|  L \| R  |            -        |   5 | 2 = 7  |   F | T = T   |
|  L << R  |            -        |  5 << 2 = 20 |  T << T = 2   |
|  L >> R  |            -        |  5 >> 2 = 1  |  T >> T = 0   |
|    ~R    |            -        |      ~2 = -3 |      ~T = -2  |
|        <td colspan=4><em>Операции сравнения</em></td>         |
...
|  L <= R  | 'a' <= 'b' = T      |  5 <= 2 = F  |  F <= T = T   |
|       <td colspan=4><em>Логические операции</em></td>         |
